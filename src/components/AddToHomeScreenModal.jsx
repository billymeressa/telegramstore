...
const AddToHomeScreenModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-end justify-center pointer-events-none pb-[calc(20px+var(--tg-safe-area-bottom))]">
            ...
            {/* Card */}
            <div className="bg-white w-[90%] max-w-sm rounded-2xl shadow-2xl p-5 pointer-events-auto relative transform transition-all animate-in slide-in-from-bottom-10 duration-500">
                <button 
