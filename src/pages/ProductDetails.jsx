                ...
                <div className="flex gap-3 mt-6 mb-2">
                    ...
                    >
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.06-.14-.09-.21-.09-.09 0-1.51.96-4.27 2.82-.4.27-.76.4-1.08.39-.35-.01-1.03-.2-1.54-.35-.62-.18-1.12-.28-1.07-.59.02-.16.24-.32.65-.48 2.56-1.11 4.26-1.84 5.12-2.2 2.44-1.02 2.94-1.2 3.27-1.2.07 0 .23.01.33.09.09.07.12.17.13.24 0 .04.01.1 0 .16z" />
                        </svg> {isOutOfStock ? 'Sold Out' : 'Buy Now'}
                    </button>
                    <button
                        disabled={isOutOfStock}
                        onClick={() => {
